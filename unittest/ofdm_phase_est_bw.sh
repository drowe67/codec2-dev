...
ofdm_mod --in /dev/zero --testframes 300 --mode 2020 --ldpc 2 -p 312 --verbose 0 | cohpsk_ch - - -40 --Fs 8000 -f 10 --ssbfilt 1 --faster --raw_dir $RAW | ofdm_demod --out /dev/null --testframes --mode 2020 --verbose 1 --ldpc 2 -p 312 --bandwidth 1 2> $results
cat $results
