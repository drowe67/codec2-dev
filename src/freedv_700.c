...
/* TODO - do these need to be statics? Will this break if we have parallel instances? */

extern struct OFDM_CONFIG *ofdm_config;

extern int ofdm_bitsperframe;
extern int ofdm_nuwbits;
extern int ofdm_ntxtbits;
