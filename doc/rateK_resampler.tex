...
\label{fig:mel_fhz}
\includegraphics[width=10cm]{ratek_mel_fhz}
\end{figure}
...
\includegraphics[width=10cm]{warp_fhz_k}
\end{figure}
...
\begin{figure}[h]
\caption{Filters $h(k)$ for $N_b=10, m=1 \ldots L, F0=200 \textrm{Hz}, L=20$}
\label{fig:filters_h}
\includegraphics[width=10cm]{filters_h.png}
\end{figure}
