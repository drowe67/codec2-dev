...
\end{itemize}
This procedure should be used for any resampling, e.g. from rate $L$ to rate $K$, or rate $K$ to rate $L$, to ensure constant energy is preserved across all resampling operations.
