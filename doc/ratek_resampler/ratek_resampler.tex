...
\item NN codecs suggest it may be possible to infer or regenerate narrow bandwidth peaks from simpler, lower bit rate (lower $N_b$) spectral representations.  This could be performed via a post filtering algorithm or by training a neural net. 
...
\begin{tabular}{c c c c}
 ...
 \hline
\end{tabular}
\caption{Subjective speech quality for a male sample with Rate $K$ amplitudes and synthesised phase}
